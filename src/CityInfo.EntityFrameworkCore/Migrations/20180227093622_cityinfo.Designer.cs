...
namespace CityInfo.Migrations
{
    ...
    [Migration("20180227093622_cityinfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityInfo.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CityInfo.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CityInfo.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CityInfo.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CityInfo.Authorization.Roles.Role", b =>
                {
                    b.HasOne("CityInfo.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("CityInfo.Authorization.Users.User", "DeleterUser")
                        .WithMany()
