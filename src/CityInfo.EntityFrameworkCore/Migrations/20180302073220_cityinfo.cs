        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MasterKategoriId = table.Column<int>(nullable: true),
                    kategori = table.Column<string>(maxLength: 400, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kategori", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Kategori_Kategori_MasterKategoriId",
                        column: x => x.MasterKategoriId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Createdate = table.Column<string>(maxLength: 400, nullable: true),
                    IdKategori = table.Column<int>(nullable: false),
                    MasterTempatId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tempat_Tempat_MasterTempatId",
                        column: x => x.MasterTempatId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MasterGalleryId = table.Column<int>(nullable: true),
                    id_kategori = table.Column<int>(nullable: false),
                    id_tempat = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gallery_Gallery_MasterGalleryId",
                        column: x => x.MasterGalleryId,
                        principalTable: "Gallery",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Gallery_Kategori_id_kategori",
                        column: x => x.id_kategori,
                        principalTable: "Kategori",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Gallery_Tempat_id_tempat",
                        column: x => x.id_tempat,
                        principalTable: "Tempat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gallery_MasterGalleryId",
                table: "Gallery",
                column: "MasterGalleryId");

            migrationBuilder.CreateIndex(
                name: "IX_Gallery_id_kategori",
                table: "Gallery",
                column: "id_kategori");

            migrationBuilder.CreateIndex(
                name: "IX_Gallery_id_tempat",
                table: "Gallery",
                column: "id_tempat");

            migrationBuilder.CreateIndex(
                name: "IX_Kategori_MasterKategoriId",
                table: "Kategori",
                column: "MasterKategoriId");

            migrationBuilder.CreateIndex(
                name: "IX_Tempat_MasterTempatId",
                table: "Tempat",
                column: "MasterTempatId");
        }
